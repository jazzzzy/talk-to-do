            ...
            <form id="add-task-form" onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  required
                  maxLength={200}
                  className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-4 text-white text-sm placeholder-white/20 focus:outline-none focus:border-indigo-400/50 focus:bg-white/10 transition-all shadow-inner"
                />
              </div>
